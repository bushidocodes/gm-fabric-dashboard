...
public abstract class GMFDashboardTest {
    protected GMFDashboardSite gmfDashboardSite;
	public static GMFDashboardDeployment deployment = new GMFDashboardDeployment();
	...
	public void testFrameworkSetup() {
        ...
        if(deployment.browserType.equals(BrowserType.MOZILLA_FIREFOX)) {
            ...
            gmfDashboardSite = new GMFDashboardSite(new FirefoxDriver(firefoxBinary, firefoxProfile, browserCapabilities));
        } else if(deployment.browserType.equals(BrowserType.GOOGLE_CHROME)) {
            System.setProperty("webdriver.chrome.driver", "/opt/chromedriver");
            gmfDashboardSite = new GMFDashboardSite(new ChromeDriver(browserCapabilities));
        }
